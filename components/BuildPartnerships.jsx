...
const BuildPartnerships = () => {
  return (
    ...
    <div className="p-8 md:p-12 mb-8 mt-12 md:mt-18 w-screen">
            <div className="my-24 mx-4 sm:mx-8 md:mx-12 lg:mx-16 xl:mx-20">
                <h1 className="bg-gradient-to-r bg-clip-text  text-transparent from-indigo-300 via-cyan-200 to-cyan-500 animate-text text-4xl md:text-7xl font-extrabold mb-2">Build Partnerships</h1>
                <p className="text-md md:text-xl font-normal text-blue-950 dark:text-gray-200 mb-6">Connect with other buyers and build partnerships. Lorem ipsum dolor sit amet, 
