  ...
  return (
    ...
    <div class="p-8 md:p-12 mb-8 mt-12 md:mt-18 w-screen">
            <div className="my-24 mx-4 sm:mx-8 md:mx-12 lg:mx-16 xl:mx-20">
                <h1 className="text-blue-950 dark:text-gray-200 text-4xl md:text-7xl font-extrabold mb-2">Sell Your Business</h1>
                <p className="text-md md:text-xl font-normal text-blue-950 dark:text-gray-200 mb-6">This is the Create Listing page. Lorem ipsum dolor sit amet, 
