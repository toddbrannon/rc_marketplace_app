    ...
    <div className="p-8 mx-auto max-w-screen-xl md:p-12 mb-2 mt-2">
            <div className="hero-cols grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="process-steps-container container-medium with-padding">
                      <div className="process-step-container process-step-1">
                        <div className="process-step-title-container">
                          <h1 className="process-step-title text-gray-100 dark:text-gray-100 text-5xl md:text-7xl font-extrabold mb-2">Sell</h1>
                          <div className="process-step-title-overlay text-gray-100 dark:text-gray-100 text-5xl md:text-7xl font-extrabold mb-2">Sell</div>
                        </div>
                      </div>
                      <div className="process-step-container process-step-2">
                        <div className="process-step-title-container">
                        <h1 className="process-step-title text-gray-100 dark:text-gray-100 text-5xl md:text-7xl font-extrabold mb-2">Buy</h1>
                        <div className="process-step-title-overlay text-gray-100 dark:text-gray-100 text-5xl md:text-7xl font-extrabold mb-2">Buy</div>
                        </div>
                      </div>
                      <div className="process-step-container process-step-3">
                        <div className="process-step-title-container">
                        <h1 className="process-step-title text-gray-100 dark:text-gray-100 text-5xl md:text-7xl font-extrabold mb-2">Connect.</h1>
                        <div className="process-step-title-overlay text-gray-100 dark:text-gray-100 text-5xl md:text-7xl font-extrabold mb-2">Connect.</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="hero-logo p-8 md:p-12 mb-8 mt-8 w-full hidden lg:block">
                    ...
                    {/* <img className="w-96 h-96" src="/assets/images/BlueMinimalistHandShake.svg" alt="image description"/> */}
                    <Image
