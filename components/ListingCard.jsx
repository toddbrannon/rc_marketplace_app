  ...
  return (
    <div className="grid md:grid-cols-2 gap-8 mx-4 sm:mx-8 md:mx-12 lg:mx-16 xl:mx-20">
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 md:p-12">
            ...
            <h2 className="text-blue-900 text-3xl font-extrabold mb-2">Listing 1</h2>
            ...
            <a href="#" className="learn-more">Learn more
                <svg aria-hidden="true" className="w-4 h-4 ml-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 md:p-12">
            ...
            <h2 className="text-blue-900 text-3xl font-extrabold mb-2">Listing 2</h2>
                <p className="text-sm md:text-lg font-normal text-dark-blue mb-4">
